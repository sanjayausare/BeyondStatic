        ...
        <div class="col-lg-10 col-sm-12" >
          ...
          <div class="col-lg-12" className={styles.brandName} style={{lineHeight: '5rem'}}>Beyond Static</div>
            ...
            <div class="col-lg-12" style={{marginTop: '40px'}}>
                ...
                <div className="col-lg-3 col-md-6 col-sm-12 fourbtns"><div><Button onClick={launchHandler} variant="outlined" className={styles.fourbtns} size="large" color="primary" style={{fontSize: '1.1rem', padding: 'auto 5%', borderRadius:'50px', marginBottom:'4%'}}>Launch&nbsp;&nbsp;<i class="fas fa-arrow-alt-circle-right"></i></Button></div></div>
