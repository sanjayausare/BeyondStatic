    ...
    return(
        <div className={cardClasses} style={{marginTop: '5%', marginLeft: '0', boxShadow: '0px 3px 6px #00000029', padding: '2%', borderRadius: '20px', marginRight: '0'}}>
            ...
            <div className="row">
                ...
                <div className="col-lg-2 col-md-2 col-sm-2"><img className="img img-fluid float-right" src="./images/plus.svg" alt="plus" style={{marginTop: '4%'}} onClick={newProjHandler}  /></div>
            </div>
        </div>
    )
